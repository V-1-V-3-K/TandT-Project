...
cv2.createTrackbar("upper_hue", "bars", 101, 180, hello)
cv2.createTrackbar("upper_saturation", "bars", 160, 255, hello)
cv2.createTrackbar("upper_value", "bars", 148, 255, hello)
cv2.createTrackbar("lower_hue", "bars", 51, 180, hello)
cv2.createTrackbar("lower_saturation", "bars", 42, 255, hello)
cv2.createTrackbar("lower_value", "bars", 30, 255, hello)
